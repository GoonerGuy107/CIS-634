...
struct
  ...
  val _ = Theory.link_parents
          ("exercise9",
          Arbnum.fromString "1580434672",
          Arbnum.fromString "875115")
          [("indexedLists",
  ...
  fun op constructiveDeilemmaRule x = x
    val op constructiveDeilemmaRule =
  ...
  [("absorptionRule",absorptionRule,DB.Thm),
   ("constructiveDeilemmaRule",constructiveDeilemmaRule,DB.Thm),
